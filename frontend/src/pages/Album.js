...
const Album = () => {
  ...
  const songs = [
    ...
    { id: 4, title: "Song 4", duration: "5:10" },
    { id: 5, title: "Song 5", duration: "3:55" },
    { id: 6, title: "Song 6", duration: "4:30" },
    { id: 7, title: "Song 7", duration: "3:40" },
    { id: 8, title: "Song 8", duration: "4:15" }
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-end mb-12">
          ...
          <div>
            ...
            <h1 className="text-5xl md:text-7xl font-bold mt-4 mb-6">{album.title}</h1>
          ...
          <div className="divide-y divide-gray-800">
            {songs.map((song, index) => (
              <div key={song.id} className="grid grid-cols-12 px-4 py-2 hover:bg-gray-800 hover:bg-opacity-50 group">
                ...
                <div className="col-span-3 text-gray-400">{album.title}</div>
